...
Client actions are the client-side version of dosytERP's "Server
...
In the dosytERP Web code, a client action only requires two pieces of
information:
...
* Providing said object. Two different types of objects can be mapped
  ...
  * An dosytERP Web widget, which must inherit from
