...
!define UNINSTALL_REGISTRY_KEY_SERVER "${UNINSTALL_BASE_REGISTRY_KEY}\dosyt ERP ${VERSION}"
...
; English
LangString DESC_dosyt_Server ${LANG_ENGLISH} "Install the dosyt ERP with all the dosyt standard modules."
...
LangString DESC_CanNotInstallPostgreSQL ${LANG_ENGLISH} "You can not install the PostgreSQL database without the dosyt ERP"
...
LangString TITLE_dosyt_Server ${LANG_ENGLISH} "dosyt ERP"
...
Section $(TITLE_dosyt_Server) Sectiondosyt_Server
    ...
    # If there is a previous install of the dosyt ERP, keep the login/password from the config file
