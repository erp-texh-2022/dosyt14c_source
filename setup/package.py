...
class KVMWinTestExe(KVM):
    def run(self):
        ...
        self.ssh('/cygdrive/c/"Program Files"/"dosyt {sv}"/python/python.exe \'c:\\Program Files\\dosyt {sv}\\server\\odoo-bin\' -d mycompany -i base --stop-after-init'.format(sv=setupversion))
