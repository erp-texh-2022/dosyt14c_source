...
"""
Miscellaneous tools used by dosytERP.
"""
import cProfile
import collections
import datetime
...
def file_open(name, mode="r", subdir='addons', pathinfo=False, filter_ext=None):
    """Open a file from the dosytERP root, using a subdir folder.
    ...
    if os.path.isabs(name):
        ...
        for root in adps + [rtp]:
            ...
            # It is outside the dosytERP root: skip zipfile lookup.
...
def scan_languages():
    """ Returns all languages supported by dosytERP for translation
...
class UnquoteEvalContext(defaultdict):
    """Defaultdict-based evaluation context that returns
       ...
       the evaluation.
       Mostly useful for evaluating dosytERP domains/contexts that
