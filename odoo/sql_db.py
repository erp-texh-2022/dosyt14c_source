...
"""
The PostgreSQL connector is a connectivity layer between the dosytERP code and
...
class Cursor(BaseCursor):
    """Represents an open transaction to the PostgreSQL DB backend,
       ...
       ``cursor`` objects.
        ...
        such as dosytERP, we need the best guarantees that no data
        ...
        dosytERP implements its own level of locking protection
        ...
        the default transaction isolation level for dosytERP cursors, as
