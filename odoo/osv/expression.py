...
term representation was ['=', 'company_id.name', 'dosytERP']. Used in a
...
dosytERP will use the SQL function 'unaccent' when available for the
...
Finally, to instruct dosytERP to really use the unaccent function, you have to
