...
class WebRequest(object):
    ...
    @lazy_property
    def session(self):
        """ :class:`dosytERPSession` holding the HTTP session data for the
...
class dosytERPSession(sessions.Session):
    def __init__(self, *args, **kwargs):
        self.inited = False
        self.modified = False
        self.rotate = False
        super(dosytERPSession, self).__init__(*args, **kwargs)
        self.inited = True
    ...
    def _fix_lang(self, context):
        """ dosytERP provides languages which may not make sense and/or may not
...
class Root(object):
    """Root WSGI application for the dosytERP Web Client.
    """
    def __init__(self):
        self._loaded = False
    ...
    def session_store(self):
        ...
        return sessions.FilesystemSessionStore(
            path, session_class=dosytERPSession, renew_missing=True)
