...
HOTMAIL_1 = u"""<div>
    <div dir="ltr"><br>
        I have an amazing company, i'm learning dosytERP, it is a small company yet, but plannig to grow up quickly.
        <br><br>Kindest regards,<br>xxx<br>
        <div>
            <div id="SkyDrivePlaceholder">
            </div>
            <hr id="stopSpelling">
            Subject: Re: your dosytERP.com registration<br>From: xxx@xxx.xxx<br>To: xxx@xxx.xxx<br>Date: Wed, 27 Mar 2013 17:12:12 +0000
            <br><br>
            Hello xxx,
            <br>
            I noticed you recently created an dosytERP.com account to access dosytERP Apps.
            <br>
            You indicated that you wish to use dosytERP in your own company.
...
<div class="WordSection1">
        ...
        <p class="MsoNormal">
            <span style="font-size:11.0pt;font-family:&quot;Calibri&quot;,&quot;sans-serif&quot;;color:#1F497D">
                ...
                If we adopt dosytERP we will probably move to Linux or look for a hosted SaaS option.
            </span>
        </p>
        <p></p>
        <p></p>
            ...
            <div style="border:none;border-top:solid #B5C4DF 1.0pt;padding:3.0pt 0in 0in 0in">
                <p class="MsoNormal">
                    ...
                    <span style="font-size:10.0pt;font-family:&quot;Tahoma&quot;,&quot;sans-serif&quot;">
                        dosytERP Enterprise [mailto:sales@dosyt.com]
                        <br><b>Sent:</b> Monday, 11 March, 2013 14:47<br><b>To:</b> Alan Widmer<br><b>Subject:</b> Re: your dosytERP.com registration
                    </span>
                </p>
                <p></p>
                <p></p>
        ...
        <p></p>
        <p>I noticed you recently downloaded dosytERP. </p>
        <p></p>
        <p>
            Uou mentioned you wish to use dosytERP in your own company. Please let me more about your
            business needs and requirements? When will you be available to discuss about your project?
        </p>
        <p></p>
        <p>Thanks for your interest in dosytERP, </p>
        <p></p>
...
MSOFFICE_1_OUT = [u'I noticed you recently downloaded dosytERP.', 'Uou mentioned you wish to use dosytERP in your own company.', 'Belgium: +32.81.81.37.00']
